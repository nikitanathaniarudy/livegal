 ...
 */
export async function fetchOptions(said, model, context = [], relationships = [], playerName = '', characterKey = 'default', language = '', scenarioContext = '') {
  const prompt = buildPrompt(said, context, relationships, playerName, characterKey, language, scenarioContext);
...
function buildPrompt(said, context, relationships = [], playerName = '', characterKey = 'default', language = '', scenarioContext = '') {
  ...
  return `${identity}${personaBlock}${scenarioBlock}${contextBlock}${relationshipBlock}
